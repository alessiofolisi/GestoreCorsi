...
public class FXMLController {
    ...
    void numeroStudenti(ActionEvent event) {
    	...
    	Map<Corso , Integer> iscritti = this.model.getIscritti(periodo);
    ...
    void stampaDivisione(ActionEvent event) {
    	...
    	if(codins==null || codins.equals("")) { txtRisultato.setText("Per favore inserisci il codice di un corso"); return;}
